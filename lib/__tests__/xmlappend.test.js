...
const targetAttr = `<?xml version="1.0" encoding="utf-8"?>
<root target-attr="&apos;">
  <child/>
  <child/>
</root>`;
...
<child-doc21 attr="&quot;" />
<child-doc22>
<nested><nested attr="&quot;"></nested></nested>
</child-doc22>
</root>`;
...
describe('xmlappend', function () {
  ...
  it('should escape entities in attributes', function () {
    expect(xmlappend(targetAttr, docAttr)).toMatchSnapshot();
  });

  it('should append 1 doc to empty root', function () {
    expect(xmlappend('<root></root>', doc1)).toMatchSnapshot();
  });
